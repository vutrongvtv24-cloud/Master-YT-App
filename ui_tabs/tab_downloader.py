...
class DownloaderTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.btn_download_comments = QPushButton("Tải & Lọc Bình luận")
    ...
    def _start_generic_download_task(self, task_type):
        ...
        if self.main_window.is_operation_running:
            QMessageBox.warning(self.main_window, "Đang xử lý", "Một tác vụ khác trên tool đang chạy. Vui lòng chờ.")
            return
        ...
        self.current_download_thread.finished.connect(self.main_window.on_worker_thread_finished)
        self.current_download_thread.finished.connect(self._reset_tab_download_state_slot)

        self.main_window.worker_started(self.current_download_thread, thread_display_name)
